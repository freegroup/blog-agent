...
const APP_ID = secret("PINTEREST_APP_ID");
const APP_SECRET = secret("PINTEREST_APP_SECRET");
...
async function publish(payload) {
  ...
  // A Pin without an image cannot be created. The pinterest briefing must produce
  // one; if it did not, this article simply is not pinnable.
...
server.listen(PORT, "127.0.0.1", () => {
  ...
  if (!refreshToken) {
    console.log(`[sink-pinterest] not authorized yet — open http://localhost:${PORT}/oauth/start in a browser once.`);
